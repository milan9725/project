...
def logout(request):
	try:
		...
		msg="User Logout Out Successfully"
		return render(request,'login.html',{'msg':msg})
	except:
		msg="User Logout Out Successfully"
		return render(request,'login.html',{'msg':msg})
...
def forgot_password(request):
	if request.method=="POST":
		try:
			...
			querystring = {"authorization":"cmDgYpBdLSQM9qklPwx0CGfOnN572RUeKzbvAorVWHZiF43jEyH2RCQ41dIigXJwzqhjTAbmVvG5c6ay","variables_values":otp,"route":"otp","numbers":mobile}
